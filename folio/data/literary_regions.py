...
def _build_regions() -> dict[str, dict[str, Any]]:
    ...
    stubs: list[tuple] = [
        ...
        (
            ...
            ["岛屿", "乡土", "现代主义", "身份"],
            [{"name": "白先勇", "blurb": "台北人与华丽缘。"}, {"name": "三毛", "blurb": "流浪、沙漠与岛屿的散文写作。"}, {"name": "黄春明", "blurb": "乡土文学代表。"}, {"name": "朱天心", "blurb": "当代台湾的锐利声音。"}],
            [{"title": "撒哈拉的故事", "author": "三毛"}, {"title": "梦里花落知多少", "author": "三毛"}, {"title": "台北人", "author": "白先勇"}, {"title": "儿子的大玩偶", "author": "黄春明"}],
            "gat",
        ),
        (
            "hongkong",
